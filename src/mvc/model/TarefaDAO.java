...
public class TarefaDAO {
    ...
    public void adicionaMensagem(Tarefa tarefa) {
        try {
            String sql = "INSERT INTO Tarefa (mensagem) values(?)";
            PreparedStatement stmt = connection.prepareStatement(sql);
            stmt.setString(1,tarefa.getMensagem());
            stmt.execute();
            stmt.close();
    ...
    public void adiciona(Tarefa tarefa) {
        try {
            ...
            PreparedStatement stmt = connection.prepareStatement(sql);
            stmt.setString(1,tarefa.getMensagem());
            stmt.setString(2, tarefa.getUsuario());
    ...
    public void altera(Tarefa tarefa) {
        try {
            String sql = "UPDATE Tarefas SET mensagem=?, finalizado=?, " +
    ...
    public void apaga() {
        try {
            String sql = "TRUNCATE table Tarefa";
            PreparedStatement stmt = connection.prepareStatement(sql);
            stmt.executeUpdate();
            stmt.close();
        } catch(SQLException e) {System.out.println(e);}
